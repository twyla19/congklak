...
# lubang pilih agent
PLAYER_ONE_SPACES = [True, True, True, True, True, True, True, False,
                     False, False, False, False, False, False, False, False]
PLAYER_TWO_SPACES = [False, False, False, False, False, False, False, 
                     False, True, True, True, True, True, True, True, False]


class Agent():
    """Abstract Class for agent to play dakon."""

    def move(self, game=None):
        """Return a move index based on a game"""
        print("Agent Choose= "+str(self._move(game)))
    ...
    def valid_indices(game):
        ...
        possible_indices = map(lambda p: p[0] if p[1] else None, zip(range(0, 15), valid_spaces))
