...
class DakonEnv(gym.Env):
    """Dakon Game Environment"""
    ...
    def _step(self, action):
        ...
        state_init = DakonEnv.game_state(self._game)
        ...
        state_new = DakonEnv.game_state(self._game)
    ...
    def _reset(self):
        ...
        return DakonEnv.game_state(self._game)
    ...
    def game_state(game):
        ...
        board = game.board()
        b = board[0:7] + board[8:15]
        s = [DakonEnv._board_index_to_hot_encoding(count) for count in b]
